...
function getCriteriaJa ()
{
  return [
    ['A',   '1.1.1',  '非テキストコンテンツ'],
    ['A',   '1.2.1',  '音声のみ及び映像のみ (収録済)'],
    ['A',   '1.2.2',  'キャプション (収録済)'],
    ['A',   '1.2.3',  '音声解説、又はメディアに対する代替 (収録済)'],
    ['AA',  '1.2.4',  'キャプション (ライブ)'],
    ['AA',  '1.2.5',  '音声解説 (収録済)'],
    ['AAA', '1.2.6',  '手話 (収録済)'],
    ['AAA', '1.2.7',  '拡張音声解説 (収録済)'],
    ['AAA', '1.2.8',  'メディアに対する代替 (収録済)'],
    ['AAA', '1.2.9',  '音声のみ (ライブ)'],
    ['A',   '1.3.1',  '情報及び関係性'],
    ['A',   '1.3.2',  '意味のある順序'],
    ['A',   '1.3.3',  '感覚的な特徴'],
    ...
    ['AA',  '2.4.7',  'フォーカスの可視化'],
    ['AAA', '2.4.8',  '現在位置'],
    ['AAA', '2.4.9',  'リンクの目的 (リンクのみ)'],
    ['AAA', '2.4.10', 'セクション見出し'],
    ['A',   '2.5.1',  'ポインタのジェスチャ'],
    ['A',   '2.5.2',  'ポインタのキャンセル'],
    ['A',   '2.5.3',  '名前 (name) のラベル'],
    ['A',   '2.5.4',  '動きによる起動'],
    ['AAA', '2.5.5',  'ターゲットのサイズ'],
    ['AAA', '2.5.6',  '入力メカニズム非依存'],
    ['A',   '3.1.1',  'ページの言語'],
    ['AA',  '3.1.2',  '一部分の言語'],
    ['AAA', '3.1.3',  '一般的ではない用語'],
    ['AAA', '3.1.4',  '略語'],
