...
function getUiJa ()
{
  return {
    ...
    'update-additional-criteria': '追加の達成基準を更新しました',
    ...
    'usingtemplate-exp': '「テンプレートシートの生成」を押すことで、テストの種類とレベルに応じてテンプレートシートを生成します。「テンプレートを適用」か「テンプレートの選択行のみ適用」を押して、URLのシートにテンプレートを適用します。',
    ...
    'exportreport-exp': '「試験結果HTMLを出力」を押して、ウェブサイトのテスト結果を記載したHTMLファイルをGoogleドライブに生成します。',
