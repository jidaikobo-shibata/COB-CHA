...
function getUiJa ()
{
  return {
    ...
    'sheet-control': 'シート操作',
    'generate': 'シート生成',
    'collect-sheets': 'シート取得',
    'delete': '削除',
    'screenshot': 'スクリーンショット',
    'add-screenshot': 'スクリーンショット追加',
    'generate-config-sheet': '設定シート生成',
    ...
    'sheet-control-exp': '1行に1つのURLを入力し、「シート生成」を押すと、URLの数だけシートが生成されます。 「シート取得」を押すと、すべてのURLのシートがtextareaに取得されます。「削除」をチェックすると、textareaにあるシートを削除できます。',
    'generate-config-exp': '「*Config*」という名前のコンフィグ用シートを生成します。',
